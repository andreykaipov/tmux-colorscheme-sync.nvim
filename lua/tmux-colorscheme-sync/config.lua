...
M.default_settings = {
	...
	state_file = nil, -- path to write tmux set commands so tmux can source them on cold start
	...
	manage_focus = true, -- register FocusLost/FocusGained autocmds to dim/restore highlights
